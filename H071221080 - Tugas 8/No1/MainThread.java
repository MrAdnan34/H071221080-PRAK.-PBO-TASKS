...
public class MainThread {
        ...
        for (int i = 0; i < DATA_SOURCES; i++) {
            ...
            executor.execute(() -> {
                ...
                if (executionTime > 4) {
                    ...
                    try {
                        // Thread akan nganggur/menunggu karena ceritanya ini sedang mengakses data sources
    ...
    // synchronized ditambahkan untuk menjaga method agar dalam 1 waktu, hanya 1 Thread yang bisa mengaksesnya. Ini untuk menghindari adanya race condition
